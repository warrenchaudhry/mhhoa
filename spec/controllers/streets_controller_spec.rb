...
RSpec.describe StreetsController, type: :controller do
  ...
  let(:valid_attributes) { attributes_for(:street) }
  let(:invalid_attributes) { attributes_for(:street, name: nil) }
